         ...
         :service_blocks => [
           {
             ...
             :param_name_tag => ['td:nth-of-type(1) span', "td[colspan='2'] div.b-tariff__note__summary", 'td:first-child'],
             :param_value_tag => ['td:nth-of-type(n+2)', "td[colspan='2'] div.b-tariff__note__text"],
           },
         ]
        }
      end
