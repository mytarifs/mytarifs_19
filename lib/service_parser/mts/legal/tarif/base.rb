module ServiceParser
  class Mts
    class Legal::Tarif::Base < ServiceParser::Mts
      def service_parsing_tags
        {
         ...
         :service_blocks => [
           {
             :block_tag => [" > div.bp-holder:nth-of-type(-n+2):contains('Обязательные платежи')"],
             :block_name_tag => ["h2"],
           ...
           {
             :block_tag => ["div.bp-holder:nth-of-type(-n+2):contains('Обязательные платежи') > div.FederalHolderMarker:nth-of-type(1)"],
             :block_name_tag => ["h2"],
             :block_name_substitutes => {},
