...
@tc.create_tarif_class({
  :id => _tele_portfel_interneta, :name => 'Портфель интернета', :operator_id => Category::Operator::Const::Tele2, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {:http => 'http://msk.tele2.ru/internet/dlya-telefonov/portfel-interneta-3g4g/',
...
scg_tele_portfel_interneta = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPrice,  
      :formula => {:params => {:max_sum_volume => 15000.0, :price => 599.0}, :window_over => 'month' } } )

  #internet for scg_tele_add_trafic_100mb option
  scg_tele_add_trafic_100mb = @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_100mb_tele_portfel_interneta' }, 
    {:name => "price for scg_tele_add_trafic_100mb_tele_portfel_interneta"}, 
  ...
  scg_tele_add_trafic_3gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_3gb_tele_portfel_interneta' }, 
    {:name => "price for scg_tele_add_trafic_3gb_tele_portfel_interneta"}, 
  ...
  scg_tele_add_trafic_5gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_5gb_tele_portfel_interneta' }, 
    {:name => "price for scg_tele_add_trafic_5gb_tele_portfel_interneta"}, 
