...
scg_tele_paket_interneta = @tc.add_service_category_group(
  ...
  scg_tele_add_trafic_100mb = @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_100mb_tele_paket_interneta' }, 
    {:name => "price for scg_tele_add_trafic_100mb_tele_paket_interneta"}, 
  ...
  scg_tele_add_trafic_3gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_3gb_tele_paket_interneta' }, 
    {:name => "price for scg_tele_add_trafic_3gb_tele_paket_interneta"}, 
  ...
  scg_tele_add_trafic_5gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_5gb_tele_paket_interneta' }, 
    {:name => "price for scg_tele_add_trafic_5gb_tele_paket_interneta"}, 
