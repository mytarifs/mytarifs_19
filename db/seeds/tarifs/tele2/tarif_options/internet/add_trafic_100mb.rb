...
@tc.create_tarif_class({
  :id => _tele_add_trafic_100mb, :name => 'Добавить трафика 100Mb', :operator_id => Category::Operator::Const::Tele2, :privacy_id => _person, :standard_service_id => _special_service,
