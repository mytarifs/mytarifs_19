...
@tc.create_tarif_class({
  :id => _tele_add_speed_5gb, :name => 'Добавить скорости 5Gb', :operator_id => Category::Operator::Const::Tele2, :privacy_id => _person, :standard_service_id => _special_service,
  ...
  :dependency => {
    :incompatibility => {
      :add_speed_internet_options => [_tele_internet_from_phone, _tele_day_in_net, _tele_add_speed_3gb, _tele_add_speed_100mb, _tele_add_speed_5gb]
    }, 
