...
@tc.create_tarif_class({
  :id => _tele_very_black_04_2016, :name => 'Очень черный 04_2016', :operator_id => Category::Operator::Const::Tele2, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://msk.tele2.ru/tariff/blacker/', 
    :buy_http => 'http://msk.shop.tele2.ru/products/choose_tariff/_gv/tariff-id_10660',
...
#Добавление новых service_category_group
  ...
  scg_tele_very_black_04_2016_calls = @tc.add_service_category_group(
    {:name => 'scg_tele_very_black_04_2016_calls' }, 
    {:name => "price for scg_tele_very_black_04_2016_calls"}, 
  ...
  scg_tele_very_black_04_2016_sms = @tc.add_service_category_group(
    {:name => 'scg_tele_very_black_04_2016_sms' }, 
    {:name => "price for scg_tele_very_black_04_2016_sms"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeForFixedPrice,  
      :formula => {:params => {:max_count_volume => 400.0, :price => 0.0}, :window_over => 'month' } }
    )

  #internet included in tarif
  scg_tele_very_black_04_2016_internet = @tc.add_service_category_group(
    {:name => 'scg_tele_very_black_04_2016_internet' }, 
    {:name => "price for scg_tele_very_black_04_2016_internet"}, 
  ...
  scg_tele_add_speed_100mb = @tc.add_service_category_group(
    {:name => 'scg_tele_add_speed_100mb_tele_very_black_04_2016' }, 
    {:name => "price for scg_tele_add_speed_100mb_tele_very_black_04_2016"}, 
  ...
  scg_tele_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_speed_3gb_tele_very_black_04_2016' }, 
    {:name => "price for scg_tele_add_speed_3gb_tele_very_black_04_2016"}, 
  ...
  scg_tele_add_speed_5gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_speed_5gb_tele_very_black_04_2016' }, 
    {:name => "price for scg_tele_add_speed_5gb_tele_very_black_04_2016"}, 
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 299.0} } })
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_tele_very_black_04_2016_calls[:id])
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_tele_very_black_04_2016_sms[:id])
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_tele_very_black_04_2016_internet[:id])
