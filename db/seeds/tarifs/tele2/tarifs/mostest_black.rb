...
@tc.create_tarif_class({
  :id => _tele_mostest_black, :name => 'Сверхчерный', :operator_id => Category::Operator::Const::Tele2, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://msk.tele2.ru/tariff/ultrablack/', 
    :buy_http => 'http://msk.shop.tele2.ru/products/choose_tariff/_gv/tariff-id_12182',
...
#Добавление новых service_category_group
  ...
  scg_tele_mostest_black_calls = @tc.add_service_category_group(
    {:name => 'scg_tele_mostest_black_calls' }, 
    {:name => "price for scg_tele_mostest_black_calls"}, 
  ...
  scg_tele_mostest_black_sms = @tc.add_service_category_group(
    {:name => 'scg_tele_mostest_black_sms' }, 
    {:name => "price for scg_tele_mostest_black_sms"}, 
  ...
  scg_tele_mostest_black_internet = @tc.add_service_category_group(
    {:name => 'scg_tele_mostest_black_internet' }, 
    {:name => "price for scg_tele_mostest_black_internet"}, 
  ...
  scg_tele_add_trafic_100mb = @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_100mb_tele_mostest_black' }, 
    {:name => "price for scg_tele_add_trafic_100mb_tele_mostest_black"}, 
  ...
  scg_tele_add_trafic_3gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_3gb_tele_mostest_black' }, 
    {:name => "price for scg_tele_add_trafic_3gb_tele_mostest_black"}, 
  ...
  scg_tele_add_trafic_5gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_5gb_tele_mostest_black' }, 
    {:name => "price for scg_tele_add_trafic_5gb_tele_mostest_black"}, 
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 1199.0} } })
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_tele_mostest_black_calls[:id])
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_tele_mostest_black_sms[:id])
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_tele_mostest_black_internet[:id])
