...
@tc.create_tarif_class({
  ...
  :features => {
    ...
    :buy_http => 'http://msk.shop.tele2.ru/products/choose_tariff/_gv/tariff-id_14531',
...
#Добавление новых service_category_group
  ...
  scg_tele_black_calls = @tc.add_service_category_group(
    {:name => 'scg_tele_black_calls' }, 
    {:name => "price for scg_tele_black_calls"}, 
  ...
  scg_tele_black_sms = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeForFixedPrice,  
      :formula => {:params => {:max_count_volume => 200.0, :price => 0.0}, :window_over => 'month' } }
    )
  ...
  scg_tele_add_trafic_100mb = @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_100mb_tele_black' }, 
    {:name => "price for scg_tele_add_trafic_100mb_tele_black"}, 
  ...
  scg_tele_add_trafic_3gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_3gb_tele_black' }, 
    {:name => "price for scg_tele_add_trafic_3gb_tele_black"}, 
  ...
  scg_tele_add_trafic_5gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_5gb_tele_tele_black' }, 
    {:name => "price for scg_tele_add_trafic_5gb_tele_tele_black"}, 
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 199.0} } })
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_tele_black_calls[:id])
