...
@tc.create_tarif_class({
  ...
  :features => {
    :http => 'http://msk.tele2.ru/tariff/theblackest/', 
    :buy_http => 'http://msk.shop.tele2.ru/products/choose_tariff/_gv/tariff-id_10661',
...
#Добавление новых service_category_group
  ...
  scg_tele_add_trafic_100mb = @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_100mb_tele_most_black' }, 
    {:name => "price for scg_tele_add_trafic_100mb_tele_most_black"}, 
  ...
  scg_tele_add_trafic_3gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_3gb_tele_most_black' }, 
    {:name => "price for scg_tele_add_trafic_3gb_tele_most_black"}, 
  ...
  scg_tele_add_trafic_5gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_trafic_5gb_tele_most_black' }, 
    {:name => "price for scg_tele_add_trafic_5gb_tele_most_black"}, 
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 599.0} } })
