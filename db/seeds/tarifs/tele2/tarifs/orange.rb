...
@tc.create_tarif_class({
  :id => _tele_orange, :name => 'Оранжевый', :operator_id => Category::Operator::Const::Tele2, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://msk.tele2.ru/tariff/orange/', 
    :buy_http => 'http://msk.shop.tele2.ru/products/choose_tariff/_gv/tariff-id_14530',
...
#Own and home regions, Internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => Price::StandardFormula::Const::PriceBySumVolumeMByte, :formula => {:params => {:price => 1.5} } })  
