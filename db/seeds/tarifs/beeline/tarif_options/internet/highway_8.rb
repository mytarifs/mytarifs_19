...
@tc.create_tarif_class({
  :id => _bln_highway_8, :name => 'Хайвей 8 Гб', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {:http => 'http://moskva.beeline.ru/customers/products/mobile/services/details/hayvey-8-gb-tv/',
...
scg_bln_highway_8 = @tc.add_service_category_group(
    {:name => 'scg_bln_highway_8' }, 
    {:name => "price for scg_bln_highway_8"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPrice,  
      :formula => {:params => {:max_sum_volume => 8000.0, :price => 600.0}, :window_over => 'month' } }
    )

  #internet for add_speed_1gb option
  scg_bln_add_speed_1gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_1gb_bln_highway_8' }, 
    {:name => "price for scg_bln_add_speed_1gb_bln_highway_8"}, 
  ...
  scg_bln_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_3gb_bln_highway_8' }, 
    {:name => "price for scg_bln_add_speed_3gb_bln_highway_8"}, 
...
#internet for auto_add_speed option
  scg_bln_auto_add_speed= @tc.add_service_category_group(
    {:name => 'scg_bln_auto_add_speed_bln_highway_8' }, 
    {:name => "price for scg_bln_auto_add_speed_bln_highway_8"}, 
...
#  @tc.add_only_service_category_tarif_class(category)  
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_highway_8[:id])
