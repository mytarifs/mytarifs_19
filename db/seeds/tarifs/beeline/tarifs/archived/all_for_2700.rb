...
@tc.create_tarif_class({
  :id => _bln_all_for_2700, :name => 'Всё за 2700', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {:http => 'http://moskva.beeline.ru/customers/products/mobile/tariffs/details/vse-za-2700/',
    :buy_http => 'http://moskva.beeline.ru/shop/basket?shopProductId=187010',
...
#Добавление новых service_category_group
  ...
  scg_bln_all_for_2700_calls = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxDurationMinuteForFixedPrice,  
      :formula => {:params => {:max_duration_minute => 4000.0, :price => 0.0}, :window_over => 'month' } }
    )
  ...
  scg_bln_all_for_2700_internet = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_2700_internet' }, 
    {:name => "price for scg_bln_all_for_2700_internet"}, 
  ...
  scg_bln_add_speed_1gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_1gb_bln_all_for_2700' }, 
    {:name => "price for scg_bln_add_speed_1gb_bln_all_for_2700"}, 
  ...
  scg_bln_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_3gb_bln_all_for_2700' }, 
    {:name => "price for scg_bln_add_speed_3gb_bln_all_for_2700"}, 
...
#internet for auto_add_speed option
  scg_bln_auto_add_speed= @tc.add_service_category_group(
    {:name => 'scg_bln_auto_add_speed_bln_all_for_2700' }, 
    {:name => "price for scg_bln_auto_add_speed_bln_all_for_2700"}, 
