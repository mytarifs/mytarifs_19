...
@tc.create_tarif_class({
  :id => _bln_all_for_1500_post, :name => 'Всё за 1500 (постоплатный)', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {:http => 'http://moskva.beeline.ru/customers/products/mobile/tariffs/details/vse-za-1500-postoplatnyy/',
    :buy_http => 'http://moskva.beeline.ru/shop/basket?shopProductId=116396',
...
#Добавление новых service_category_group
  ...
  scg_bln_all_for_1500_post_calls = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1500_post_calls' }, 
    {:name => "price for scg_bln_all_for_1500_post_calls"}, 
  ...
  scg_bln_all_for_1500_post_sms = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1500_post_sms' }, 
    {:name => "price for scg_bln_all_for_1500_post_sms"}, 
  ...
  scg_bln_all_for_1500_post_internet = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1500_post_internet' }, 
    {:name => "price for scg_bln_all_for_1500_post_internet"}, 
  ...
  scg_bln_add_speed_1gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_1gb_bln_all_for_1500_post' }, 
    {:name => "price for scg_bln_add_speed_1gb_bln_all_for_1500_post"}, 
  ...
  scg_bln_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_3gb_bln_all_for_1500_post' }, 
    {:name => "price for scg_bln_add_speed_3gb_bln_all_for_1500_post"}, 
...
#internet for auto_add_speed option
  scg_bln_auto_add_speed= @tc.add_service_category_group(
    {:name => 'scg_bln_auto_add_speed_bln_all_for_1500_post' }, 
    {:name => "price for scg_bln_auto_add_speed_bln_all_for_1500_post"}, 
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1500_post_calls[:id])
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1500_post_sms[:id])
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1500_post_internet[:id])
...
#_sc_rouming_bln_bad_internet_regions, Internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 1, :standard_formula_id => Price::StandardFormula::Const::PriceBySumVolumeMByte, :formula => {:params => {:price => 9.95} } })  
