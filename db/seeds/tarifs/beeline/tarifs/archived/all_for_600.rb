...
@tc.create_tarif_class({
  :id => _bln_all_for_600, :name => 'Всё за 600', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {:http => 'http://moskva.beeline.ru/customers/products/mobile/tariffs/details/vse-za-600/',
    :buy_http => 'http://moskva.beeline.ru/shop/basket?shopProductId=111494',
...
#Добавление новых service_category_group
  ...
  scg_bln_add_speed_1gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_1gb_bln_all_for_600' }, 
    {:name => "price for scg_bln_add_speed_1gb_bln_all_for_600"}, 
  ...
  scg_bln_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_3gb_bln_all_for_600' }, 
    {:name => "price for scg_bln_add_speed_3gb_bln_all_for_600"}, 
...
#internet for auto_add_speed option
  scg_bln_auto_add_speed= @tc.add_service_category_group(
    {:name => 'scg_bln_auto_add_speed_bln_all_for_600' }, 
    {:name => "price for scg_bln_auto_add_speed_bln_all_for_600"}, 
