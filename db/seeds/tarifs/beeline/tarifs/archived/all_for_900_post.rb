...
@tc.create_tarif_class({
  ...
  :features => {:http => 'http://moskva.beeline.ru/customers/products/mobile/tariffs/details/vse-za-900-postoplatnyy/',
    :buy_http => 'http://moskva.beeline.ru/shop/basket?shopProductId=116395',
...
#Добавление новых service_category_group
  ...
  scg_bln_all_for_900_post_calls = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_900_post_calls' }, 
    {:name => "price for scg_bln_all_for_900_post_calls"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxDurationMinuteForFixedPrice,  
      :formula => {:params => {:max_duration_minute => 1100.0, :price => 0.0}, :window_over => 'month' } }
    )

  #sms included in tarif
  scg_bln_all_for_900_post_sms = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_900_post_sms' }, 
    {:name => "price for scg_bln_all_for_900_post_sms"}, 
  ...
  scg_bln_all_for_900_post_internet = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_900_post_internet' }, 
    {:name => "price for scg_bln_all_for_900_post_internet"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPrice,  
      :formula => {:params => {:max_sum_volume => 12000.0, :price => 0.0}, :window_over => 'month' } }
    )

  #internet for add_speed_1gb option
  scg_bln_add_speed_1gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_1gb_bln_all_for_900_post' }, 
    {:name => "price for scg_bln_add_speed_1gb_bln_all_for_900_post"}, 
  ...
  scg_bln_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_3gb_bln_all_for_900_post' }, 
    {:name => "price for scg_bln_add_speed_3gb_bln_all_for_900_post"}, 
...
#internet for auto_add_speed option
  scg_bln_auto_add_speed= @tc.add_service_category_group(
    {:name => 'scg_bln_auto_add_speed_bln_all_for_900_post' }, 
    {:name => "price for scg_bln_auto_add_speed_bln_all_for_900_post"}, 
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_900_post_calls[:id])
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_900_post_sms[:id])
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_900_post_internet[:id])
...
category = {:uniq_service_category => 'own_country_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_900_post_sms[:id])
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 1,:standard_formula_id => Price::StandardFormula::Const::PriceByCountVolumeItem, :formula => {:params => {:price => 3.45} } })
