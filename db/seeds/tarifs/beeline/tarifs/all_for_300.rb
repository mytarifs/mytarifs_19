...
@tc.create_tarif_class({
  :id => _bln_all_for_300, :name => 'Всё за 300', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://moskva.beeline.ru/customers/products/mobile/tariffs/details/vse-za-300/',
...
#Добавление новых service_category_group
  ...
  scg_bln_all_for_300_calls = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_300_calls' }, 
    {:name => "price for scg_bln_all_for_300_calls"}, 
  ...
  scg_bln_all_for_300_sms = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_300_sms' }, 
    {:name => "price for scg_bln_all_for_300_sms"}, 
  ...
  scg_bln_all_for_300_internet = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_300_internet' }, 
    {:name => "price for scg_bln_all_for_300_internet"}, 
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_300_calls[:id])
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_300_sms[:id])
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_300_internet[:id])
