...
@tc.create_tarif_class({
  :id => _bln_all_for_1200, :name => 'Всё за 1200', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://moskva.beeline.ru/customers/products/mobile/tariffs/details/vse-za-1200/',
    :buy_http => 'http://moskva.beeline.ru/shop/basket?shopProductId=190287',
...
#Добавление новых service_category_group
  ...
  scg_bln_all_for_1200_calls = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1200_calls' }, 
    {:name => "price for scg_bln_all_for_1200_calls"}, 
  ...
  scg_bln_all_for_1200_sms = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1200_sms' }, 
    {:name => "price for scg_bln_all_for_1200_sms"}, 
  ...
  scg_bln_all_for_1200_internet = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1200_internet' }, 
    {:name => "price for scg_bln_all_for_1200_internet"}, 
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1200_calls[:id])
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_abroad_countries/to_operators', 
  :filtr => {:to_abroad_countries => {:in => Category::Country::Bln::International_1, :name => 'Билайн, услуги СНГ, Грузия телефоны Билалайн'}, :to_operators => {:in => [Category::Operator::Const::Beeline, :name => 'партнер оператора'] }}}
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1200_sms[:id])
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1200_internet[:id])
