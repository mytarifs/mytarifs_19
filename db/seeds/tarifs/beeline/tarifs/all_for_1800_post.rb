...
@tc.create_tarif_class({
  :id => _bln_all_for_1800_post, :name => 'Всё за 1800 (постоплатный)', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://moskva.beeline.ru/customers/products/mobile/tariffs/details/vse-za-1800-postoplatnyy/',
    :buy_http => 'http://moskva.beeline.ru/shop/basket?shopProductId=190301',
...
#Добавление новых service_category_group
  ...
  scg_bln_all_for_1800_post_calls = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1800_post_calls' }, 
    {:name => "price for scg_bln_all_for_1800_post_calls"}, 
  ...
  scg_bln_all_for_1800_post_sms = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1800_post_sms' }, 
    {:name => "price for scg_bln_all_for_1800_post_sms"}, 
  ...
  scg_bln_all_for_1800_post_internet = @tc.add_service_category_group(
    {:name => 'scg_bln_all_for_1800_post_internet' }, 
    {:name => "price for scg_bln_all_for_1800_post_internet"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPrice,  
      :formula => {:params => {:max_sum_volume => 15000.0, :price => 0.0}, :window_over => 'month' } }
    )

  #internet for add_speed_1gb option
  scg_bln_add_speed_1gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_1gb_for_1800_internet' }, 
    {:name => "price for scg_bln_add_speed_1gb_for_1800_internet"}, 
  ...
  scg_bln_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_bln_add_speed_3gb_for_1800_internet' }, 
    {:name => "price for scg_bln_add_speed_3gb_for_1800_internet"}, 
...
#internet for auto_add_speed option
  scg_bln_auto_add_speed= @tc.add_service_category_group(
    {:name => 'scg_bln_auto_add_speed_for_1800_internet' }, 
    {:name => "price for scg_bln_auto_add_speed_for_1800_internet"}, 
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 1800.0} } })
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1800_post_calls[:id])
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1800_post_sms[:id])
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_all_for_1800_post_internet[:id])
