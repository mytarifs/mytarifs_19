...
@tc.create_tarif_class({
  :id => _bln_by_second, :name => 'Посекундный', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://moskva.beeline.ru/customers/products/mobile/tariffs/details/posekundniy/',
    :buy_http => 'http://moskva.beeline.ru/shop/basket?shopProductId=116571',
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators',}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => Price::StandardFormula::Const::PriceBySumDurationSecond, :formula => {:params => {:price => 0.05} } })
