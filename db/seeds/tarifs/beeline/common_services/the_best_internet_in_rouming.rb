...
@tc.create_tarif_class({
  :id => _bln_the_best_internet_in_rouming, :name => 'Самый выгодный интернет в роуминге', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _common_service,
  ...
  :dependency => {
    ...
    :general_priority => _gp_common_service,#_gp_tarif_option_with_limits,
...
#bln_the_best_internet_in_rouming_1, Internet
category = {:uniq_service_category => 'abroad_countries/internet', 
  :filtr => {:abroad_countries => {:in => Category::Country::Bln::The_best_internet_in_rouming_groups_1, :name => 'Страны Билайна для "Самый выгодный интернет в роуминге", Европа, СНГ и популярные страны' }}}
