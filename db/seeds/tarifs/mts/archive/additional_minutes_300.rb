...
@tc.create_tarif_class({
  :id => _mts_additional_minutes_300, :name => 'Дополнительные пакеты минут 300', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _special_service,
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 390.0} } })
...
#All own country regions, Calls, Outcoming, to_own_home_regions, to_own_operator
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_additional_minutes_300_included_in_tarif_calls[:id]) 
  category = {:uniq_service_category => 'own_country_regions/calls_out/to_own_and_home_regions/to_operators',}
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_additional_minutes_300_included_in_tarif_calls[:id]) 
