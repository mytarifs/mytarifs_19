...
@tc.create_tarif_class({
  ...
  scg_s_mts_planshet_online = @tc.add_service_category_group(
    {:name => 'scg_s_mts_planshet_online' }, 
    {:name => "price for scg_s_mts_planshet_online"}, 
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 420.0} } })

#All Russia rouming, internet, with turbo-buttons
#Own and home regions, Internet
  category = {:uniq_service_category => 'own_and_home_regions/internet',}
  @tc.add_grouped_service_category_tarif_class(category, scg_s_mts_planshet_online[:id])
...
#МТС Планшет Онлайн
#Для подключения/отключения опции «МТС Планшет Онлайн»:
#воспользуйтесь страницей planshet.mts.ru;
#наберите на своем планшете *855#вызов или *111*855#;
#отправьте SMS с текстом 855 на номер 111;
#воспользуйтесь Интернет-Помощником.
#Готовый комплект с опцией «МТС Планшет Онлайн» можно приобрести в любом салоне-магазине МТС. Предложение действительно до 14 июля 2014 года включительно.
#TODO#Опцию «МТС Планшет Онлайн» могут подключить абоненты всех тарифных планов МТС, за исключением тарифных планов «SIM», «i-Онлайнер», «Онлайнер», «Супер Онлайнер», «Заботливый», «Классный» и всех модификаций перечисленных тарифных планов.
#Опция доступна для подключения только один раз. После отключения повторное подключение недоступно.
...
#Сколько стоит
#МТС Планшет Онлайн
#Плата за использование опции «МТС Планшет Онлайн» - 5 руб.
#С 15 июля 2014 года плата за использование опции «МТС Планшет Онлайн» составит 13 руб.
#Настроить автоматическое пополнение счета
#Указана стоимость использования опции при нахождении на территории России.
#Все цены указаны с учетом НДС.

#МТС ПланшетЕжемесячная плата за опцию – 400 руб. (на тарифных планах «МТС Коннект»),  450 руб. (на прочих тарифных планах, кроме «МТС Коннект»)
...
МТС ПланшетМобильный Интернет в рамках опции «МТС Планшет»Мобильный Интернет в рамках опции «МТС Планшет» действует для абонентов г. Москвы и Московской области по всей 
...
Одновременное подключение «МТС Планшет» с другими опциями Опция «МТС Планшет» взаимоисключаемая с группой опций «БИТ», «БИТ+Мобильное ТВ», «СуперБИТ», 
