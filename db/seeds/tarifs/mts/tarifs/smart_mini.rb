...
@tc.create_tarif_class({
  ...
  :features => {
    :http => 'http://www.mts.ru/mob_connect/tariffs/tariffs/smart_mini/', 
    :buy_http => 'http://shop.mts.ru/tariff/redirect.php?ID=0&regionId=1826',
...
#Добавление новых service_category_group
  ...
  scg_mts_smart_mini_included_in_tarif_calls = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxDurationMinuteForFixedPrice,  
      :formula => {:params => {:max_duration_minute => 250.0, :price => 0.0}, :window_over => 'month' } }
    )
  ...
  scg_mts_smart_mini_included_in_tarif_sms = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeForFixedPrice,  
      :formula => {:params => {:max_count_volume => 250.0, :price => 0.0}, :window_over => 'month' } }
    )
  ...
  scg_mts_add_speed_100mb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_100mb_mts_smart_mini' }, 
    {:name => "price for scg_mts_add_speed_100mb_mts_smart_mini"}, 
  ...
  scg_mts_add_speed_500mb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_500mb_mts_smart_mini' }, 
    {:name => "price for scg_mts_add_speed_500mb_mts_smart_mini"}, 
  ...
  scg_mts_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_2gb_mts_smart_mini' }, 
    {:name => "price for scg_mts_add_speed_1gb_mts_smart_mini"}, 
  ...
  scg_mts_add_speed_2gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_2gb_mts_smart_mini' }, 
    {:name => "price for scg_mts_add_speed_2gb_mts_smart_mini"}, 
  ...
  scg_mts_add_speed_5gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_5gb_mts_smart_mini' }, 
    {:name => "price for scg_mts_add_speed_5gb_mts_smart_mini"}, 
...
#Own country, Calls, Outcoming, to_own_country, to_not_own_operator
  ...
  :filtr => {:to_operators => {:not_in => [Category::Operator::Const::Mts] }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 2,:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 14.0} } })
...
#Переход на тариф
  ...
  {:standard_formula_id => Price::StandardFormula::Const::PriceByItemIfUsed, :formula => {:params => {:price => 0.0} } },
...
#Ежемесячная плата
  ...
  {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 100.0} } },
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
...
#Own country, Calls, Outcoming, to_own_and_home_region, to_not_own_operator
  ...
  :filtr => {:to_operators => {:not_in => [Category::Operator::Const::Mts] }}}
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0,:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 2.0} } },
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
...
#Own country, sms, Outcoming, to_own_home_regions
  ...
  @tc.add_grouped_service_category_tarif_class(category, 
    ...
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 1,:standard_formula_id => Price::StandardFormula::Const::PriceByCountVolumeItem, :formula => {:params => {:price => 1.5} } },
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
...
#Own country, sms, Outcoming, to_own_country
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 1,:standard_formula_id => Price::StandardFormula::Const::PriceByCountVolumeItem, :formula => {:params => {:price => 3.8} } },
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )

#Own country, Internet
  category = {:uniq_service_category => 'own_country_regions/internet',}
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_smart_mini_included_in_tarif_internet[:id], :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_add_speed_100mb[:id], :tarif_set_must_include_tarif_options => [_mts_turbo_button_100_mb, _mts_everywhere_as_home_smart] )
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_add_speed_500mb[:id], :tarif_set_must_include_tarif_options => [_mts_turbo_button_500_mb, _mts_everywhere_as_home_smart] )
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_add_speed_1gb[:id], :tarif_set_must_include_tarif_options => [_mts_turbo_button_1_gb] )
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_add_speed_2gb[:id], :tarif_set_must_include_tarif_options => [_mts_turbo_button_2_gb, _mts_everywhere_as_home_smart] )
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_add_speed_5gb[:id], :tarif_set_must_include_tarif_options => [_mts_turbo_button_5_gb, _mts_everywhere_as_home_smart] )
