...
@tc.create_tarif_class({
  ...
  :features => {
    :http => 'http://www.mts.ru/mob_connect/tariffs/tariffs/smart_top/', 
    :buy_http => 'http://shop.mts.ru/tariff/redirect.php?ID=4013233&regionId=1826',
...
#Добавление новых service_category_group
  ...
  scg_mts_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_1gb_mts_smart_top' }, 
    {:name => "price for scg_mts_add_speed_1gb_mts_smart_top"}, 
