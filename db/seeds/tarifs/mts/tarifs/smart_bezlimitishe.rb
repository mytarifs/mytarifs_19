...
@tc.create_tarif_class({
  :id => _mts_smart_bezlimitishe, :name => 'Smart Безлимитище', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://www.mts.ru/mob_connect/tariffs/tariffs/smart_bezlimitishhe/', 
#    :buy_http => 'http://www.shop.mts.ru/tarify/vigodnye_zvonki_na_vse_nomera/?_ga=1.215480151.1594351290.1430824855',
    :phone_number_type => ["Федеральный", "Городской"],
    :internet_sharing_with_other_devices => {:paid => "Только после подключения услуги 'Единый интернет' за 100 рублей. Объем интернет-трафика при этом ограничивается 10 Гб."},
...
#Добавление новых service_category_group
  ...
  scg_mts_smart_bezlimitishe_included_in_tarif_calls = @tc.add_service_category_group(
    {:name => 'scg_mts_smart_bezlimitishe_included_in_tarif_calls' }, 
    {:name => "price for _scg_mts_smart_bezlimitishe_included_in_tarif_calls"}, 
  ...
  scg_mts_smart_bezlimitishe_included_in_tarif_sms = @tc.add_service_category_group(
    {:name => 'scg_mts_smart_bezlimitishe_included_in_tarif_sms' }, 
    {:name => "price for _scg_mts_smart_bezlimitishe_included_in_tarif_sms"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeForFixedPrice,  
      :formula => {:params => {:max_count_volume => 1100.0, :price => 0.0}, :window_over => 'month' } }
    )

  #internet included in tarif
  scg_mts_smart_bezlimitishe_included_in_tarif_internet = @tc.add_service_category_group(
    {:name => 'scg_mts_smart_bezlimitishe_included_in_tarif_internet' }, 
    {:name => "price for _scg_mts_smart_bezlimitishe_included_in_tarif_internet"}, 
  ...
  scg_mts_add_speed_100mb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_100mb_mts_smart_bezlimitishe' }, 
    {:name => "price for scg_mts_add_speed_100mb_mts_smart_bezlimitishe"}, 
  ...
  scg_mts_add_speed_500mb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_500mb_mts_smart_bezlimitishe' }, 
    {:name => "price for scg_mts_add_speed_500mb_mts_smart_bezlimitishe"}, 
  ...
  scg_mts_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_1gb_mts_smart_bezlimitishe' }, 
    {:name => "price for scg_mts_add_speed_1gb_mts_smart_bezlimitishe"}, 
  ...
  scg_mts_add_speed_2gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_2gb_mts_smart_bezlimitishe' }, 
    {:name => "price for scg_mts_add_speed_2gb_mts_smart_bezlimitishe"}, 
  ...
  scg_mts_add_speed_5gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_5gb_mts_smart_bezlimitishe' }, 
    {:name => "price for scg_mts_add_speed_5gb_mts_smart_bezlimitishe"}, 
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByMonth, :formula => {:params => {:price => 570.0} } })
...
#All_russia_rouming, Calls, Outcoming, to_own_and_home_region, to_own_operator
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_smart_bezlimitishe_included_in_tarif_calls[:id])
...
#All_russia_rouming, sms, Outcoming, to_own_home_regions
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_smart_bezlimitishe_included_in_tarif_sms[:id])
...
#All_russia_rouming, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_smart_bezlimitishe_included_in_tarif_internet[:id])
