...
@tc.create_tarif_class({
  :id => _mts_smart_plus, :name => 'Smart+', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://www.mts.ru/mob_connect/tariffs/tariffs/smart_plus/', 
    :buy_http => 'http://shop.mts.ru/tariff/redirect.php?ID=2117617&regionId=1826',
...
#Добавление новых service_category_group
  ...
  scg_mts_add_speed_100mb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_100mb_mts_smart_plus' }, 
    {:name => "price for scg_mts_add_speed_100mb_mts_smart_plus"}, 
  ...
  scg_mts_add_speed_500mb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_500mb_mts_smart_plus' }, 
    {:name => "price for scg_mts_add_speed_500mb_mts_smart_plus"}, 
  ...
  scg_mts_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_1gb_mts_smart_plus' }, 
    {:name => "price for scg_mts_add_speed_1gb_mts_smart_plus"}, 
  ...
  scg_mts_add_speed_2gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_2gb_mts_smart_plus' }, 
    {:name => "price for scg_mts_add_speed_2gb_mts_smart_plus"}, 
  ...
  scg_mts_add_speed_5gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_5gb_mts_smart_plus' }, 
    {:name => "price for scg_mts_add_speed_5gb_mts_smart_plus"}, 
...
#All_russia_rouming, Calls, Outcoming, to_own_and_home_region, to_own_operator
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_smart_plus_included_in_tarif_calls[:id])
...
#All_russia_rouming, sms, Outcoming, to_own_home_regions
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_smart_plus_included_in_tarif_sms[:id])
...
#All_russia_rouming, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_smart_plus_included_in_tarif_internet[:id])
