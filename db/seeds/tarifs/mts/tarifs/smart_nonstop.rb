...
#Добавление новых service_category_group
  ...
  scg_mts_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_1gb_mts_smart_nonstop' }, 
    {:name => "price for scg_mts_add_speed_1gb_mts_smart_nonstop"}, 
...
#All_russia_rouming, Calls, Outcoming, to_own_and_home_region, to_not_own_operator
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_smart_nonstop_included_in_tarif_calls[:id])
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 1,:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 2.0} } }) #приоритет 2 из-за опции Везде как дома
