...
#Own and home regions, Internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => Price::StandardFormula::Const::PriceBySumVolumeMByte, :formula => {:params => {:price => 4.5} } })
...
#_all_russia_rouming rouming, mms, outcoming, to all own country regions, to own operator
  category = {:uniq_service_category => 'own_and_home_regions/mms_out', 
  :filtr => {:to_operators => {:in => [Category::Operator::Const::Mts] }}}
