...
@tc.create_tarif_class({
  :id => _mts_mts_connect_4, :name => 'МТС Коннект-4', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://www.mts.ru/mob_connect/tariffs/tariffs/connect4/',
