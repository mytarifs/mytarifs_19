...
@tc.create_tarif_class({
  :id => _mts_bit_abroad, :name => 'БИТ за границей', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {
    :http => 'http://www.mts.ru/mob_connect/roaming/i_roaming/discount_roaming/bit_abroad/bit/',
    :limit_on_internet_speed => {:speed => "128 КБит/с"},
...
#bit_abrod_1 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 100.0, :price => 400.0}, :window_over => 'day' } } )
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 2, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 1000.0, :price => 0.0}, :window_over => 'day' } } )
...
#bit_abrod_2 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 30.0, :price => 350.0}, :window_over => 'day' } } )
...
#bit_abrod_3 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 50.0, :price => 300.0}, :window_over => 'day' } } )
...
#bit_abrod_5 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 30.0, :price => 500.0}, :window_over => 'day' } } )
...
#bit_abrod_6 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 5.0, :price => 1200.0}, :window_over => 'day' } } )
...
#наберите на своем мобильном телефоне *212#вызов 
#наберите на своем мобильном телефоне *111*2222#вызов
#отправьте бесплатное SMS на номер 111 с текстом 2222 - для подключения (с текстом 22220 - для отключения).
...
#3.Если вы подключили опцию, но пользуетесь доступом в Интернет в России или в домашнем регионе, а не за границей, тарификация интернет-трафика осуществляется в соответствии 
