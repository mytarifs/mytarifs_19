...
@tc.create_tarif_class({
  :id => _mts_maxi_bit_abroad, :name => 'Макси БИТ за границей', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {
    :http => 'http://www.mts.ru/mob_connect/roaming/i_roaming/discount_roaming/bit_abroad/maxi_bit/',
...
#bit_abrod_1 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 200.0, :price => 600.0}, :window_over => 'day' } } )
...
#bit_abrod_3 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 100.0, :price => 600.0}, :window_over => 'day' } } )
...
#bit_abrod_4 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 70.0, :price => 600.0}, :window_over => 'day' } } )
...
#bit_abrod_5 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 70.0, :price => 900.0}, :window_over => 'day' } } )
...
#bit_abrod_6 rouming, internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed, 
      :formula => {:params => {:max_sum_volume => 10.0, :price => 2200.0}, :window_over => 'day' } } )
