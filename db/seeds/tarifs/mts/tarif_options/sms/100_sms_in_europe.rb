...
@tc.create_tarif_class({
  :id => _mts_100_sms_in_europe, :name => '100 SMS в Европе', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _special_service,
...
#Own country, sms, Outcoming
  @tc.add_one_service_category_tarif_class(_sctcg_mts_europe_rouming_sms_outcoming, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeWithMultipleUseMonth,  
      :formula => {:params => {:max_count_volume => 100.0, :price => 350.0} } } )
...
#Как узнать остаток SMS и срок действия пакета - наберите на своем мобильном телефоне  *100*3#вызов
