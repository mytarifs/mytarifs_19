#SMS пакет 150 (onetime)
@tc = TarifCreator.new(Category::Operator::Const::Mts)
@tc.create_tarif_class({
  :id => _mts_onetime_sms_packet_150, :name => 'SMS пакет 150', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _special_service,
...
#Own and home regions, sms, outcoming, to own and home regions
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeWithMultipleUseMonth,  
      :formula => {:params => {:max_count_volume => 150.0, :price => 200.0}, :window_over => 'month' } } )
