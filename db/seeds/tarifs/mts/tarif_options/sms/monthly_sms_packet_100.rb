...
#Условия
#Пакеты SMS действуют на территории домашнего региона при отправке SMS сообщений на телефонные номера абонентов сотовых операторов связи 
#домашнего региона.
...
#Разовые SMS-пакеты доступны для всех пользователей не корпоративных тарифных планов и для корпоративных тарифных планов «Команда», 
#«Свой бизнес», «Бизнес общение», 
...
#В случае отключения пакета без подключения нового периодического пакета неизрасходованный остаток SMS может быть использован 
