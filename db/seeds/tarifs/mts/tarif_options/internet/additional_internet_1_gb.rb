...
@tc.create_tarif_class({
  :id => _mts_additional_internet_1_gb, :name => 'Дополнительный пакет 1 Гб', :operator_id => Category::Operator::Const::Mts, :privacy_id => _person, :standard_service_id => _special_service,
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_additional_internet_1_gb_for_smart[:id])
...
#Опции «Дополнительный пакет 1 Гб»

#Тарифная опция: «Дополнительный пакет 1 Гб»
#Объем трафика: 1 Гб в месяц
#Стоимость: 120 руб./мес.

#Как подключить / отключить: 
#Есть два способа подключения / отключения опции «Дополнительный пакет 1 Гб»:
#наберите на своем мобильном телефоне *111*527# ;
#отправьте SMS на номер 111 с текстом: 527 – для подключения;
#5270 – для отключения.
