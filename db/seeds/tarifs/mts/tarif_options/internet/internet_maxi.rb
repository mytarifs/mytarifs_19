...
@tc.create_tarif_class({
  ...
  :dependency => {
    ...
    :prerequisites => [],
    :forbidden_tarifs => {:to_switch_on => [_mts_smart_bezlimitishe, _mts_smart_top, _mts_smart_nonstop], :to_serve => [_mts_ultra, _mts_smart_top, _mts_smart_nonstop]}, #:to_switch_on => [_mts_smart, _mts_smart_mini, _mts_smart_plus, _mts_ultra, _mts_mts_connect_4, _mts_smart_top], :to_serve => []},
    :multiple_use => false
  } } )
  ...
  scg_mts_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_1gb_mts_internet_maxi' }, 
    {:name => "price for scg_mts_add_speed_1gb_mts_internet_maxi"}, 
