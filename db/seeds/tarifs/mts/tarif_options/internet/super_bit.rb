...
@tc.create_tarif_class({
  ...
  scg_mts_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mts_add_speed_1gb_mts_super_bit' }, 
    {:name => "price for scg_mts_add_speed_1gb_mts_super_bit"}, 
...
#  @tc.add_only_service_category_tarif_class(category)  
  ...
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 5, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForSpecialPrice,  
      :formula => {:params => {:max_sum_volume => 500.0, :price => 75.0}, :window_over => 'month' } } )
