...
@tc.create_tarif_class({
  :id => _mgf_minute_packs_25_world, :name => 'Пакеты минут 25 Мир', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
category = {:uniq_service_category => 'abroad_countries/calls_in', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_minute_packs_25_world[:id])  
