...
@tc.create_tarif_class({
  :id => _mgf_50_discount_on_all_incoming_calls, :name => 'Скидка 50% на все входящие вызовы', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {:http => 'http://moscow.megafon.ru/roaming/world/50discount.html',
    :publication_status => Content::Article::PublishStatus[:published],
    },
  :dependency => {
      :incompatibility => {:discount_on_all_incoming_calls => [_mgf_50_discount_on_all_incoming_calls, _mgf_25_discount_on_calls_to_russia_and_all_incoming],
      :international_calls_options_with_50_discount_in => [ _mgf_minute_packs_25_europe, _mgf_minute_packs_50_europe, _mgf_minute_packs_25_world, _mgf_minute_packs_50_world, _mgf_50_discount_on_all_incoming_calls, _mgf_all_world, _mgf_30_minutes_all_world, _mgf_far_countries, _mgf_option_around_world, _mgf_100_minutes_europe]}, 
