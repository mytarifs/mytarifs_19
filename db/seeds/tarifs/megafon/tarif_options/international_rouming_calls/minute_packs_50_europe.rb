...
@tc.create_tarif_class({
  :id => _mgf_minute_packs_50_europe, :name => 'Пакеты минут 50 Европа и СНГ', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
scg_minute_packs_50_europe = @tc.add_service_category_group(
  {:name => 'scg_minute_packs_50_europe' }, 
  {:name => "price for scg_minute_packs_50_europe"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxDurationMinuteForFixedPrice,  
      :formula => {:params => {:max_duration_minute => 50.0, :price => 529.0}, :window_over => 'month' } } )
...
category = {:uniq_service_category => 'abroad_countries/calls_in', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_minute_packs_50_europe[:id])  
