...
@tc.create_tarif_class({
  :id => _mgf_bit_mega_pro_150, :name => 'БИТ MegaPRO 150', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
#        _mgf_internet_24_pro, _mgf_bit_pro, _mgf_bit_mega_pro_150, _mgf_bit_mega_pro_250, _mgf_bit_mega_pro_500],
    ...
    :other_tarif_priority => {:lower => [], :higher => [_mgf_internet_in_russia]},
...
scg_mgf_bit_mega_pro_150 = @tc.add_service_category_group(
    {:name => 'scg_mgf_bit_mega_pro_150' }, 
    {:name => "price for scg_mgf_bit_mega_pro_150"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPriceIfUsed,  
      :formula => {:params => {:max_sum_volume => 150.0, :price => 14.9}, :window_over => 'day' } } )


#Own and home regions, Internet
  category = {:uniq_service_category => 'own_and_home_regions/internet',}
  @tc.add_grouped_service_category_tarif_class(category, scg_mgf_bit_mega_pro_150[:id])
