...
@tc.create_tarif_class({
  :id => _mgf_bit_pro, :name => 'БИТ PRO', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
#        _mgf_internet_24_pro, _mgf_bit_pro, _mgf_bit_mega_pro_150, _mgf_bit_mega_pro_250, _mgf_bit_mega_pro_500],
    ...
    :prerequisites => [_mgf_all_included_xs, _mgf_all_included_s, _mgf_all_included_m, _mgf_all_included_xl, _mgf_all_included_l, _mgf_all_included_vip, 
