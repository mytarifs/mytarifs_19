...
@tc.create_tarif_class({
  :id => _mgf_internet_l, :name => 'Интернет L', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {:http => 'http://moscow.megafon.ru/internet/options/internet_l.html',
...
scg_mgf_internet_l = @tc.add_service_category_group(
    {:name => 'scg_mgf_internet_l' }, 
    ...
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxSumVolumeMByteForFixedPrice,  
      :formula => {:params => {:max_sum_volume => 18000.0, :price => 890.0}, :window_over => 'month' } } )

  #internet for add_speed_1gb option
  scg_mgf_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mgf_add_speed_1gb_mgf_internet_l' }, 
    {:name => "price for scg_mgf_add_speed_1gb_mgf_internet_l"}, 
  ...
  scg_mgf_add_speed_5gb = @tc.add_service_category_group(
    {:name => 'scg_mgf_add_speed_5gb_mgf_internet_l' }, 
    {:name => "price for scg_mgf_add_speed_5gb_mgf_internet_l"}, 
...
#  @tc.add_only_service_category_tarif_class(category)  
  @tc.add_grouped_service_category_tarif_class(category, scg_mgf_internet_l[:id])
