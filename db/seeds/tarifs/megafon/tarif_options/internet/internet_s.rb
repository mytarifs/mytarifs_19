...
@tc.create_tarif_class({
  :id => _mgf_internet_s, :name => 'Интернет S', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {:http => 'http://moscow.megafon.ru/internet/options/internet_s.html',
...
scg_mgf_internet_s = @tc.add_service_category_group(
    {:name => 'scg_mgf_internet_s' }, 
    {:name => "price for scg_mgf_internet_s"}, 
  ...
  scg_mgf_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mgf_add_speed_1gb_mgf_internet_s' }, 
    {:name => "price for scg_mgf_add_speed_1gb_mgf_internet_s"}, 
  ...
  scg_mgf_add_speed_5gb = @tc.add_service_category_group(
    {:name => 'scg_mgf_add_speed_5gb_mgf_internet_s' }, 
    {:name => "price for scg_mgf_add_speed_5gb_mgf_internet_s"}, 
