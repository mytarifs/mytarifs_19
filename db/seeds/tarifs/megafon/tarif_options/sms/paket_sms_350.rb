...
@tc.create_tarif_class({
  :id => _mgf_paket_sms_350, :name => 'Пакет SMS-350', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
#mms included in tarif
  scg_mgf_paket_sms_350 = @tc.add_service_category_group(
    {:name => 'scg_mgf_paket_sms_350' }, 
    {:name => "price for scg_mgf_paket_sms_350"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeWithMultipleUseMonth,  
      :formula => {:params => {:max_count_volume => 350.0, :price => 400.0} } } )
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_country_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_mgf_paket_sms_350[:id])
