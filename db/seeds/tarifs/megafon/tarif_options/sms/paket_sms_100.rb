...
@tc.create_tarif_class({
  :id => _mgf_paket_sms_100, :name => 'Пакет SMS-100', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
#sms included in tarif
  scg_mgf_paket_sms_100 = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeWithMultipleUseMonth,  
      :formula => {:params => {:max_count_volume => 100.0, :price => 140.0} } } )
