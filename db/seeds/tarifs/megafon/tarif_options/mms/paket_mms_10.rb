...
@tc.create_tarif_class({
  :id => _mgf_paket_mms_10, :name => 'Пакет MMS-10', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
#mms included in tarif
  scg_mgf_paket_mms_10 = @tc.add_service_category_group(
    {:name => 'scg_mgf_paket_mms_10' }, 
    {:name => "price for scg_mgf_paket_mms_10"}, 
    {:calculation_order => 0, :standard_formula_id => Price::StandardFormula::Const::MaxCountVolumeForFixedPrice,  
      :formula => {:params => {:max_count_volume => 10.0, :price => 50.0}, :window_over => 'month' } } )
...
category = {:uniq_service_category => 'own_and_home_regions/mms_out',}
  @tc.add_grouped_service_category_tarif_class(category, scg_mgf_paket_mms_10[:id])
