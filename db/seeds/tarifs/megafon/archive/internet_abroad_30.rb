...
@tc.create_tarif_class({
  :id => _mgf_internet_abroad_30, :name => 'Интернет за границей, 30 Мб', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _special_service,
