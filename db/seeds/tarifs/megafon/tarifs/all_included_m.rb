...
@tc.create_tarif_class({
  :id => _mgf_all_included_m, :name => 'Мегафон все включено M', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://moscow.megafon.ru/tariffs/alltariffs/all_inclusive/all_inclusive_m/m.html',
    :buy_http => 'http://moscow.megafon.ru/zakaz/?tariff=tp_vse_vklyucheno_m',
    :phone_number_type => ["Федеральный"],
    :payment_type => "Предоплатная",
    :tv_video_content => "2 фильма и пакет ТВ-каналов 'МегаФон'",
...
#Добавление новых service_category_group
  ...
  scg_mgf_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mgf_add_speed_1gb_mgf_all_included_m' }, 
    {:name => "price for scg_mgf_add_speed_1gb_mgf_all_included_m"}, 
  ...
  scg_mgf_add_speed_5gb = @tc.add_service_category_group(
    {:name => 'scg_mgf_add_speed_5gb_mgf_all_included_m' }, 
    {:name => "price for scg_mgf_add_speed_5gb_mgf_all_included_m"}, 
