...
@tc.create_tarif_class({
  :id => _mgf_all_included_xl, :name => 'Мегафон все включено XL', :operator_id => Category::Operator::Const::Megafon, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {
    :http => 'http://moscow.megafon.ru/tariffs/alltariffs/all_inclusive/all_inclusive_xl/xl.html',
    :buy_http => 'http://moscow.megafon.ru/zakaz/?tariff=tp_vse_vklyucheno_xl',
...
#Добавление новых service_category_group
  ...
  scg_mgf_all_included_xl_calls = @tc.add_service_category_group(
    {:name => 'scg_mgf_all_included_xl_calls' }, 
    {:name => "price for scg_mgf_all_included_xl_calls"}, 
  ...
  scg_mgf_all_included_xl_sms_mms = @tc.add_service_category_group(
    {:name => 'scg_mgf_all_included_xl_sms_mms' }, 
    {:name => "price for scg_mgf_all_included_xl_sms_mms"}, 
  ...
  scg_mgf_all_included_xl_internet = @tc.add_service_category_group(
    {:name => 'scg_mgf_all_included_xl_internet' }, 
    {:name => "price for scg_mgf_all_included_xl_internet"}, 
  ...
  scg_mgf_add_speed_1gb = @tc.add_service_category_group(
    {:name => 'scg_mgf_add_speed_1gb_mgf_all_included_xl' }, 
    {:name => "price for scg_mgf_add_speed_1gb_mgf_all_included_xl"}, 
  ...
  scg_mgf_add_speed_5gb = @tc.add_service_category_group(
    {:name => 'scg_mgf_add_speed_5gb_mgf_all_included_xl' }, 
    {:name => "price for scg_mgf_add_speed_5gb_mgf_all_included_xl"}, 
...
category = {:uniq_service_category => 'own_and_home_regions/calls_out/to_own_and_home_regions/to_operators', 
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mgf_all_included_xl_calls[:id])
...
category = {:uniq_service_category => 'own_and_home_regions/sms_out/to_own_and_home_regions',}
  @tc.add_grouped_service_category_tarif_class(category, scg_mgf_all_included_xl_sms_mms[:id])
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mgf_all_included_xl_internet[:id])
