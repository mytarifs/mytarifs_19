...
module Customer::Call::Init::SmallBasket
  OwnCountryOnly = { 
    :general=> {
#    "phone_usage_type_id"=>243, 
    ...
    :own_region=> {
      "number_of_day_calls"=>2.0, 
      "duration_of_calls"=>1.331, 
      "share_of_calls_to_other_mobile"=>0.19, 
      "share_of_calls_to_fix_line"=>0.15, 
      "share_of_regional_calls"=>0.0, 
      "share_of_international_calls"=>0.0, 
      "number_of_sms_per_day"=>4.0, 
      "number_of_mms_per_day"=>0.0, 
      "internet_trafic_per_month"=>0.0, 
      "share_of_incoming_calls"=>0.5, 
      "share_of_incoming_calls_from_own_mobile"=>0.66
     }, 
    :home_region=> {
      "number_of_day_calls"=>2.0, 
      "duration_of_calls"=>1.331, 
