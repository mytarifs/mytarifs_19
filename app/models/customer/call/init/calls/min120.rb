...
module Customer::Call::Init::Calls
  Min120 = { 
    :general=> {
#    "phone_usage_type_id"=>243, 
    ...
    :own_region=> {
      "number_of_day_calls"=>4.0, 
      "duration_of_calls"=>1.01, 
      "share_of_calls_to_other_mobile"=>0.6, 
      "share_of_calls_to_fix_line"=>0.0, 
      ...
      "share_of_incoming_calls_from_own_mobile"=>0.4
     }, 
    :home_region=> {
      "number_of_day_calls"=>4, 
      "duration_of_calls"=>1.01, 
      "share_of_calls_to_other_mobile"=>0.6, 
      "share_of_calls_to_fix_line"=>0.0, 
      "share_of_regional_calls"=>0.0, 
