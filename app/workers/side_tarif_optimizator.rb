class SideTarifOptimizator < Background::Job::Base
  ...
  def perform(options, if_update_call_stat)    
    Optimizator::Runner.new.calculate_one_operator(options, if_update_call_stat)
